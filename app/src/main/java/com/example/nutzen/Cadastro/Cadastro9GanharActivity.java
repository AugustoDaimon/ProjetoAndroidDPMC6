...
public class Cadastro9GanharActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builderInputValidation = new AlertDialog.Builder(Cadastro9GanharActivity.this);
        ...
        btnContinuar.setOnClickListener((view -> {
            startActivity(new Intent(Cadastro9GanharActivity.this, HomeActivity.class));
        ...
        txtTermos.setOnClickListener((v -> {
            startActivity(new Intent(Cadastro9GanharActivity.this, TermosDeUsoActivity.class));
        }));
    }
}